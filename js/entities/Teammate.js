game.Teammate = me.Entity.extend({
    init: function (x, y, settings) {
        ...
        this.mini = me.pool.pull("miniPCreep", 10, 10, 5, {});
        ...
        if (!this.dying) {
            if (this.attacking) {
                if (!this.renderable.isCurrentAnimation("attackRight")) {
                    this.renderable.setCurrentAnimation("attackRight");
                }
    ...
    collideHandler: function (response) {
        if ((response.b.type === 'EnemyBaseEntity' || response.b.type === 'EnemyCreep' || response.b.type === 'Enemy') && !response.b.dying && !response.b.dead) {
